...
def test_parse_cggtts_basic():
    ...
    if os.path.exists(test_file):
        result = cggtts.parse_cggtts(test_file)
...
def test_parse_cggtts_track_info():
    ...
    if os.path.exists(test_file):
        ...
        first_track = tracks[0]  # Get the first track from the list
...
def test_parse_cggtts_constellation_info():
...
def test_parse_cggtts_system_delay():
